...
public class Flipkart {
	...
	public void TestFlipkartSearch() {
		...
		WebElement txtbx_search_result_text = driver.findElement(By.xpath("//*[@id='container']/div/div[3]/div[2]/div[1]/div[2]/div[1]/div/div/span"));
		...
		List<WebElement> list_of_products = driver.findElements(By.cssSelector("._4rR01T"));
		List<WebElement> list_of_products_price = driver.findElements(By.cssSelector("._30jeq3._1_WHN1"));
